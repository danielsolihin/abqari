...
function PusatSumberContent() { 
  ...
  // 3. FUNGSI FETCH DOKUMEN (HANYA DITARIK JIKA SUBJEK DIPILIH) 
  ...
  const handleUpload = async (e: React.FormEvent) => { 
    ...
    try { 
      ...
      if (res.ok && json.success) { 
        ...
        setFilterSubjectId(selectedSubjectId); // Set penapis kepada subjek yang baru dimuat naik
  ...
  const styles = { 
    page: { backgroundColor: '#f8fafc', minHeight: '100vh', fontFamily: '"Inter", "Segoe UI", sans-serif', position: 'relative' as 'relative', paddingBottom: '60px' }, 
    banner: { 
    ...
    input: { padding: '10px 15px', borderRadius: '8px', border: '1px solid #cbd5e1', fontSize: '0.95rem', width: '100%', outlineColor: '#3b0764', backgroundColor: '#f8fafc', boxSizing: 'border-box' as const }, 
        ...
        <div style={styles.mainCard}> 
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '15px', marginBottom: '25px', paddingBottom: '20px', borderBottom: '1px solid #e2e8f0' }}> 
            <h2 style={{ margin: 0, fontSize: '1.4rem', color: '#0f172a', fontWeight: '800' }}>
              Senarai Dokumen PDF ({filterSubjectId ? filteredDocuments.length : 0})
            </h2> 
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '15px', marginBottom: '20px' }}> 
            <div> 
              ...
              <input  
                type="text" placeholder="Cari nama fail PDF..."  
                disabled={!filterSubjectId}
                value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} 
                style={{ ...styles.input, cursor: !filterSubjectId ? 'not-allowed' : 'text', backgroundColor: !filterSubjectId ? '#f1f5f9' : '#f8fafc' }} 
              /> 
            </div> 
            ...
            <div> 
              ...
              <select  
                ...
                style={{ ...styles.input, border: !filterSubjectId ? '2px solid #3b0764' : '1px solid #cbd5e1' }} 
              > 
          ...
          {!filterSubjectId ? (
            <div style={{ textAlign: 'center', padding: '60px 20px', backgroundColor: '#f8fafc', borderRadius: '12px', border: '2px dashed #cbd5e1' }}>
              ...
              <p style={{ margin: '0 auto', color: '#64748b', fontSize: '0.9rem', maxWidth: '500px', lineHeight: '1.5' }}>
                Sila buat pilihan di ruangan <strong>📋 Penapis Subjek</strong> di atas untuk memaparkan senarai dokumen PDF rujukan yang berkaitan.
              </p>
            </div>
          ) : isLoading ? ( 
            ...
            <div style={{ textAlign: 'center', padding: '40px', backgroundColor: '#f8fafc', borderRadius: '8px', border: '1px dashed #cbd5e1', color: '#64748b' }}> 
              <p>Tiada dokumen PDF ditemui bagi subjek ini.</p> 
            </div> 
          ) : ( 
